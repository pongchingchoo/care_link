        ...
        <div class="container">
            ...
            <div class="right-section">
                <div class="form-container">
                    ...
                    <h2>Sign in <br> สำหรับผู้ดูแล</h2>
                    <form action="login_caregiver.php" method="post">
                        ...
                        <a href="forgot_password2.php" class="recover-link">Recover Password ?</a>
                        <button type="submit" class="btn sign-in-btn">Sign in</button>
                    </form>
                    <button class="btn register-btn" onclick="location.href='care_giver.php'">ยังไม่มีบัญชีใช่ไหม สมัครเลย</button>
                </div>
            </div>
        </div>
    </div>
