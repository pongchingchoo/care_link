...
<header>
    <div class="head">
        ...
        <nav>
            ...
            <a href="web4.php">การจ้าง</a>
            <a href="#" style="color: #ff9100;">ประวัติการจอง</a>
        </nav>
...
<h2 class="mb-3" style="margin:0 150px; margin-top:60px;">ประวัติการจองของคุณ</h2>
...
<tr>
    ...
    <td>
        <a href="caregiver_profile_show4.php?id=<?= urlencode($row['caregiver_id']) ?>">
